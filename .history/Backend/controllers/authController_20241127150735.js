...
import { connection } from '../database.js'; // Ensure this points to your DB connection
const secretKey = 'your_secret_key'; // Replace this with your actual secret
...
export const loginUser = async (req, res) => {
  ...
  try {
    ...
    const token = jwt.sign({ user_id: user.id_paciente }, secretKey, { expiresIn: '1h' });
