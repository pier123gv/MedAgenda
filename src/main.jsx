...
import { Home, Login, Account, Register, ADashboard, MostrarClientes, ShowCalendar, MostrarPersonal, MedicalDirectory, MedicalServices, NovedadesYMedios } from './pages'
